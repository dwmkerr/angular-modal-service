                ...
                self.showModal = function(options) {
                    ...
                    getTemplate(options.template, options.templateUrl)
                        .then(function(template) {
                            ...
                            //init default values on the modal for the  template linkege function
                            if (options.modalDefaultValues && typeof options.modalDefaultValues == 'object') {
                                if (options.controllerAs) {
                                    modalScope[options.controllerAs] = {};
                                    modalScope[options.controllerAs] = options.modalDefaultValues;
                                } else {
